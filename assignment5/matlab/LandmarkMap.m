%map LandmarkMap of planar point features
%
...
% add a name property, show in char()
    ...
    methods
        ...
        % constructor
        function map = LandmarkMap(nfeatures, A, varargin)
        %LandmarkMap.LandmarkMap LandmarkMap of point feature landmarks
        %
        % M = LandmarkMap(N, DIM, OPTIONS) is a LandmarkMap object that represents N random point features
        ...
        function f = feature(map, k)
            %LandmarkMap.feature Return the specified map feature
            %
